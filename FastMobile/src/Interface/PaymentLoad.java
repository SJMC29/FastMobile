...
public class PaymentLoad extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        centroAdmin.setBounds(100, 20, 350, 19);
        ...
        cargarPagos.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                cargarPagosseAgregoExitosamente(evt);
            }
        });
        ...
        CENTER.add(jPanel1);
        jPanel1.setBounds(90, 70, 850, 260);

        pathRead.setEditable(false);
        pathRead.setText("pathRead");
        CENTER.add(pathRead);
        pathRead.setBounds(230, 340, 590, 22);
    ...
    private void cargarPagosseAgregoExitosamente(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cargarPagosseAgregoExitosamente
        // TODO add your handling code here:
    }//GEN-LAST:event_cargarPagosseAgregoExitosamente
